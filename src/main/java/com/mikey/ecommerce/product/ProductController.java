...
@Tag(
    name = "Products",
    description =
        "Product catalog management endpoints for searching, viewing, creating, updating, and obsoleting products.")
  ...
  public PageResponse<ProductSummaryResponse> findAll(
    ...
    Page<Product> products =
        productRepository.searchProducts(
            search, minPrice, maxPrice, category, subcategory, brand, pageable);

    List<ProductSummaryResponse> content =
        products.getContent().stream().map(ProductMapper::toSummary).toList();
