...
@Tag(
    name = "Shopping Cart",
    description =
        "Shopping cart endpoints for managing cart items, applying coupons, and completing checkout.")
public class CartController {
  ...
  public CartResponse addItem(
      Authentication authentication, @Valid @RequestBody AddCartItemRequest request) {
  ...
  public CartResponse updateItemQuantity(
    ...
    return cartService.updateItemQuantity(authentication.getName(), cartItemId, request);
  }

  @DeleteMapping("/items/{cartItemId}")
  public CartResponse removeItem(Authentication authentication, @PathVariable Long cartItemId) {
  ...
  public CartResponse applyCoupon(Authentication authentication, @PathVariable String code) {
