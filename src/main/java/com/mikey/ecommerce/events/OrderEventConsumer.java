...
public class OrderEventConsumer {
  ...
  @KafkaListener(topics = "payment-processed", groupId = "ecommerce-group")
  public void consumePaymentProcessed(PaymentProcessedEvent event) {
    System.out.println("PAYMENT EVENT RECEIVED -> " + event);
  }

  @KafkaListener(topics = "coupon-applied", groupId = "ecommerce-group")
  public void consumeCouponApplied(CouponAppliedEvent event) {
    System.out.println("COUPON EVENT RECEIVED -> " + event);
  }
}
