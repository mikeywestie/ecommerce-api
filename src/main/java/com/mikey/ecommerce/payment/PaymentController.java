 ...
 *
 * <ul>
 *   <li>Retrieving all processed payments
 *   <li>Submitting a payment request for an order
 * </ul>
 *
 * <p>Payment processing is delegated to {@link PaymentService}, which handles business logic such
 * as authorization, persistence, and event publication.
 */
@RestController
...
@Tag(
    name = "Payments",
    description =
        "Payment processing endpoints for retrieving payment history and processing customer payments.")
public class PaymentController {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(responseCode = "404", description = "Referenced order not found")
      })
  @PostMapping
  public PaymentResponse pay(
      @Parameter(description = "Payment request containing order ID and payment details")
          @Valid
          @RequestBody
